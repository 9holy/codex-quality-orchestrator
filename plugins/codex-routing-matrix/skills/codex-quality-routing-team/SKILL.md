...
1. Follow `Codex Quality Routing` already present in context; read `../../references/RULE16.md` only if it is missing. Do not start a team or claim Sol control when the root is not `gpt-5.6-sol`.
